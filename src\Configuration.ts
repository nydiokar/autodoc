 ...
 * @property { string } commitMessage - Default commit message for the project.
 ...
 * @property {string[]} pullRequestLabels - List of labels to apply to pull requests.
 * @property {string[]} pullRequestReviewers - List of reviewers for pull requests.
 * @property {string[]} excludedFiles - List of files to exclude.
 * @property { boolean } generateJsDoc - Flag indicating whether to generate JSDoc.
 * @property { boolean } generateReadme - Flag indicating whether to generate README file.
 */
 ...
 */
/**
* Represents a configuration object for JSDoc generation.
*
* This class includes properties and methods for setting up and loading configuration data for JSDoc generation.
* It also provides getters and setters for accessing and modifying configuration settings.
*
* @class Configuration
*/
