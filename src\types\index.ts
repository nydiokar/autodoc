 ...
 * Represents an item in the Abstract Syntax Tree (AST) queue.
 * @typedef {Object} ASTQueueItem
 * @property {string} name - The name of the AST node.
 * @property {string} filePath - The file path of the AST node.
 * @property {number} startLine - The starting line number of the AST node.
 * @property {number} endLine - The ending line number of the AST node.
 * @property {string} nodeType - The type of the AST node.
 * @property {string} code - The code snippet of the AST node.
 * @property {string} [className] - The class name associated with the AST node.
 * @property {string} [methodName] - The method name associated with the AST node.
 * @property {string} [jsDoc] - The JSDoc comment associated with the AST node.
 */
