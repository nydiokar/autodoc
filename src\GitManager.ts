 ...
 */
/**
 * Interface for options to create a pull request.
 * @property {string} title - The title of the pull request.
 * @property {string} body - The body content of the pull request.
 * @property {string} head - The branch name or commit SHA of the source branch.
 * @property {string} base - The branch name on which the pull request will be based.
 * @property {string[]} [labels] - Optional array of labels to assign to the pull request.
 * @property {string[]} [reviewers] - Optional array of GitHub usernames to request as reviewers for the pull request.
 */
