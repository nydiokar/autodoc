...
/**
 * Defines a type that represents various AST node types for parsing code.
 * Key-value pair where the key is the AST node type and the value is the corresponding string representation.
 */
type AST_NODE_TYPES = {
