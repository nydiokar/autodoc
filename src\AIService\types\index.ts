 ...
 */
/**
 * Represents a group of documentation related to a file.
 * @typedef {Object} FileDocsGroup
 * @property {string} filePath - The path to the file.
 * @property {ASTQueueItem[]} classes - An array of ASTQueueItem representing classes in the file.
 * @property {ASTQueueItem[]} methods - An array of ASTQueueItem representing methods in the file.
 * @property {ASTQueueItem[]} interfaces - An array of ASTQueueItem representing interfaces in the file.
 * @property {ASTQueueItem[]} types - An array of ASTQueueItem representing types in the file.
 * @property {ASTQueueItem[]} functions - An array of ASTQueueItem representing functions in the file.
 */
